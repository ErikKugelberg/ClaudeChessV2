...
class boardManager:
    Wpawn_img   = mpimg.imread('pieces/white-pawn.png')
    Wbishop_img = mpimg.imread('pieces/white-bishop.png')
    Wknight_img = mpimg.imread('pieces/white-knight.png')
    Wrook_img   = mpimg.imread('pieces/white-rook.png')
    Wqueen_img  = mpimg.imread('pieces/white-queen.png')
    Wking_img   = mpimg.imread('pieces/white-king.png')
    Bpawn_img   = mpimg.imread('pieces/black-pawn.png')
    Bbishop_img = mpimg.imread('pieces/black-bishop.png')
    Bknight_img = mpimg.imread('pieces/black-knight.png')
    Brook_img   = mpimg.imread('pieces/black-rook.png')
    Bqueen_img  = mpimg.imread('pieces/black-queen.png')
    Bking_img   = mpimg.imread('pieces/black-king.png')
